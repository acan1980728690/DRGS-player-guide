...
![stubby_voltaic_smg](./image/_Stubby__Voltaic_SMG.png)
...
| ![  =50x50 ](../../overclock/image/Favourite.png) | Sidearm | -20% 伤害<br>所有其他武器：<br>+25% 伤害 | Reduces the damage, but increases the damage for all other weapons |
